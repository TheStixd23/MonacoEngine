...
/**
 * @class SwapChain
 * @brief Encapsula un IDXGISwapChain en Direct3D 11 para administrar buffers de presentación.
 *
...
public:
	 ...
	 *
	 * Crea el objeto IDXGISwapChain asociado a una ventana específica,
	 ...
	 *
	 * Llama a IDXGISwapChain::Present para mostrar el contenido renderizado
