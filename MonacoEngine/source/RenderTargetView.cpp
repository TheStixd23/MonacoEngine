...
// Implementación de la primera función init (para back buffer)
...
// Implementación de la segunda función init (para texturas generales)
...
// Implementación de la primera función render
...
// Implementación de la segunda función render
